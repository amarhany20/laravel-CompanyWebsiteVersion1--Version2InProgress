...
@section('content')
    <section style="margin-top: 100px" id="project">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="images p-3">
                                    <div class="text-center p-4">
                                        <img id="main-image" src="{{ asset('images/'. $project->main_image_path) }}" width="500" />
                                    </div>
                                    <div class="thumbnail text-center">
                                        @forelse ($project->images as $image)

                                        <img onclick="change_image(this)" src="{{ asset('images/'.$image->image_path)}}" width="70">
                            ...
                            <div class="col-md-6">
                                <div class="product p-4">
                                    ...
                                    <div class="mt-4 mb-3">
                                        <p class="text-uppercase text-muted brand">{{ $project->type }}</p>
